      ...
      if (!context.Functions.Any())
      {
        context.Functions.AddRange(new List<Function>
        {
          ...
          new Function
          {
            ...
            DisplayOrder = 1,
            Status = true,
            URL = "/main/product-category/index",
            IconCss = "fa-chevron-down"
          },
          new Function
          {
